...
class CreatePuzzleTest(AppTest):
    ...
    def test_create_puzzle(self):
        ...
        response = self.client.post('/create_puzzle', data=dict(
                        ...
                        hint_6="an economic system in which the central government controls owns factories, farms, and offices",
                        answer_6="communism",
                        hint_7="a form of government in which all adults take part in decisions",
                        ...
                        hint_10="a king or queen inherits the throne by birth and has complete control",
                        answer_10="absolutemonarchy",
                        hint_11="the science that studies population distribution and change",
                        answer_11="demography",
                        hint_12="a region that belongs to another state",
                        answer_12="dependency",
                        hint_13="a set of laws that define and often limit a government's power",
                        answer_13="constitution",
                        hint_14="a system in which people make, exchange, and use things that have value",
                        answer_14="economy",
                    ), follow_redirects=True)
